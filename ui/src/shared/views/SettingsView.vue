<template>
  <AppPage :scrollable="false" no-padding title="Settings" subtitle="Configure your workspace and system information.">
    <el-container style="height: 100%">
      <!-- Sidebar Menu -->
      <el-aside width="180px" style="border-right: 1px solid var(--el-border-color-lighter)">
      ...
      <!-- Content Area -->
      <el-main style="height: 100%; overflow-y: auto; padding: 0 40px 40px 40px">
        <!-- General Panel (Static) -->
